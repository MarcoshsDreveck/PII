          ...
          <div class="row">  
            <div class="text-center col-lg-12">       
              <div class="row">			
                ...
                <div class="row">
                    <div class="text-left col-lg-9">                        
                       <p class="estilo">Razão Social:&nbsp; <%= request.getParameter("razaosocial") %> </p>
                    </div>
                </div>
                <div class="row">
                    <div class="text-left col-lg-9">                        
                ...
                <div class="row">
                    <div class="text-left col-lg-9">                        
                       <p class="estilo">Endereço:&nbsp; <%= request.getParameter("endereco") %> </p>
                    </div>
                </div>
               <div class="row">
                    <div class="text-left  col-lg-9">
                ...
                <div class="row"> 
                    <div class="text-left  col-lg-9">
                        <p Class="estilo">Site: &nbsp;  <%= request.getParameter ("site")%> </p>
                    </div>
                </div>
                <div class="row"> 
                    <div class="text-left  col-lg-9">
                        <p Class="estilo">Rede Social: &nbsp;  <%= request.getParameter ("redesocial")%> </p>
                    </div>
                </div>
                <div class="row"> 
