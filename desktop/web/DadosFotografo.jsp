            ...
            <div class="text-center col-lg-12">       
              <div class="row">			
                ...
                <div class="row">
                 ...
                 <div class="row">
                    <div class="text-left  col-lg-9">
                         <p class="estilo">Data nascimento: &nbsp; <%= request.getParameter("nascimento") %> </p>
                    </div>
                </div>
                <div class="row">
                    <div class="text-left  col-lg-9">
                         <p class="estilo">Celular: &nbsp; <%= request.getParameter("celular") %> </p>
                    </div>
                </div>
                    <div class="row">
                        <div class="text-left col-lg-9">
                ...
                <div class="row"> 
                    ...
                    <div class="text-center col-lg-06">
                       ...
                       <a class="botao btn btn-primary" href="cadastro-preferencias.html" >Seguir</a>
